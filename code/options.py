...
parser.add_argument('--name', type=str, default='RRDB_0_1')
...
parser.add_argument('--model', default='RRDB', help="RRDB | RRDB_enhanced | RCAN_enhanced | SRFBN ")
...
parser.add_argument('--batch_size', type=int, default=160, help='input batch size for training')
parser.add_argument('--print_every', type=int, default=250, help='how many batches to wait before logging training status')
...
# Loss specifications
parser.add_argument('--loss', type=str, default='1*RMSE+1*GanLoss+1*FaceSphere', help='loss function configuration, you should specify like: w1*L1+w2*FaceSphere+w3*GanLoss')
